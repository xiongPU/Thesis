...
\submitted{October 2015}  % degree conferral date (January, April, June, September, or November)
...
\include{ch-expsetup/chapter-expsetup}
\include{ch-bts/chapter-bts}
\include{ch-liquid/chapter-liquid}
\include{ch-na3bi/chapter-na3bi}
%%\include{ch-usage/chapter-usage}
\include{ch-conclusion/chapter-conclusion}
\appendix % all chapters following will be labeled as appendices
\include{ch-appendicies/Gating_T}
\include{ch-appendicies/Depletion}
%\include{ch-appendicies/Boltzmann}
%\include{ch-appendicies/WeylSplit}
